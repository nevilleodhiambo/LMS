...
<form method="POST" action="{{route('hostel.store')}}">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" id="inputZip" placeholder="Enter hostel" name="name">
          </div>

          <div class="form-group col-md-3">
            <label for="inputZip">Capacity</label>
            <input type="integer" class="form-control" id="inputZip" placeholder="Enter Capacityel" name="capacity">
          </div>
